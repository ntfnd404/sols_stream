...
/// Anti-Corruption mapper: translates the generated wire DTO into the
...
final class ConnectSlotMapper {
  ...
  static ConnectSlotData toDomain(SolsStreamConnectSlot account) => ConnectSlotData(
    room: account.room.bytes,
    host: account.host.bytes,
    viewer: account.viewer.bytes,
    hostProtectedKey: account.hostProtectedKey,
    viewerProtectedKey: account.viewerProtectedKey,
    offerData: account.offerData,
    answerData: account.answerData,
    state: switch (account.state) {
      SolsStreamSlotStateOpen() => ConnectSlotState.open,
      SolsStreamSlotStateClaimed() => ConnectSlotState.claimed,
      SolsStreamSlotStateOfferReady() => ConnectSlotState.offerReady,
      SolsStreamSlotStateAnswerReady() => ConnectSlotState.answerReady,
      SolsStreamSlotStateConnected() => ConnectSlotState.connected,
      SolsStreamSlotStateExpired() => ConnectSlotState.expired,
    },
