...
# Run app
# ============================================
LOCAL_DEFINES := --dart-define-from-file=config/local.env
DEV_DEFINES := --dart-define-from-file=config/dev.env
PROD_DEFINES := --dart-define-from-file=config/prod.env
